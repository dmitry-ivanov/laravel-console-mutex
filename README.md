...
[![StyleCI](https://styleci.io/repos/59570052/shield?branch=5.8&style=flat)](https://styleci.io/repos/59570052)
[![Build Status](https://travis-ci.org/dmitry-ivanov/laravel-console-mutex.svg?branch=5.8)](https://travis-ci.org/dmitry-ivanov/laravel-console-mutex)
[![Coverage Status](https://coveralls.io/repos/github/dmitry-ivanov/laravel-console-mutex/badge.svg?branch=5.8)](https://coveralls.io/github/dmitry-ivanov/laravel-console-mutex?branch=5.8)
...
1. Install the package via Composer:
    ...
    ```shell
    composer require "illuminated/console-mutex:5.8.*"
    ```
