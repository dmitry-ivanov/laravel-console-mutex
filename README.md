...
[![StyleCI](https://github.styleci.io/repos/59570052/shield?branch=11.x&style=flat)](https://github.styleci.io/repos/59570052?branch=11.x)
[![Build Status](https://img.shields.io/github/actions/workflow/status/dmitry-ivanov/laravel-console-mutex/tests.yml?branch=11.x)](https://github.com/dmitry-ivanov/laravel-console-mutex/actions?query=workflow%3Atests+branch%3A11.x)
[![Coverage Status](https://img.shields.io/codecov/c/github/dmitry-ivanov/laravel-console-mutex/11.x)](https://app.codecov.io/gh/dmitry-ivanov/laravel-console-mutex/tree/11.x)
...
1. Install the package via Composer:
    ...
    ```shell script
    composer require "illuminated/console-mutex:^11.0"
    ```
