...
[![StyleCI](https://styleci.io/repos/59570052/shield?branch=5.3&style=flat)](https://styleci.io/repos/59570052)
[![Build Status](https://travis-ci.org/dmitry-ivanov/laravel-console-mutex.svg?branch=5.3)](https://travis-ci.org/dmitry-ivanov/laravel-console-mutex)
[![Coverage Status](https://coveralls.io/repos/github/dmitry-ivanov/laravel-console-mutex/badge.svg?branch=5.3)](https://coveralls.io/github/dmitry-ivanov/laravel-console-mutex?branch=5.3)
...
1. Install package through `composer`:
    ...
    ```shell
    composer require "illuminated/console-mutex:5.3.*"
    ```
